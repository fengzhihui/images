	 ...
	 $("#anform").validate({
		 ...
		 submitHandler : function() {
			 ...
			 if ($("input#anid", $form).val() == -1) {
				 ...
				 submitData.keyServiceNo = $("input#anid", $form).val();
			 }
			 ...
			 $.post('${path}/keyset/updateKeyset', submitData, function(data) {
...
function showImg(){
	...
	var refImageTextInfoNo = $("#refImageTextInfoId").val();
	if (type == 2 && refImageTextInfoNo != '') {
	    $.post('${path}/imagetextmore/imgPreview/' + refImageTextInfoNo, function(data) {
			if (data.success == true) {
				var mainVo = data.imageTextInfo;
				var subVoList = mainVo.subVoList;
				var imageUrl = mainVo.imageUrl.indexOf('http') == 0 ? mainVo.imageUrl : basePath + mainVo.imageUrl;
				var preItem = "<div class='msg-item multi-msg'>"
								...
								+ "<div class='cover'><p class='default-tip' style='display:none'>封面图片</p><img src='" + imageUrl + "' class='i-img' style='' /></div>"
	...
	<div class="content">
		...
		<div class="span6">
			<form class="form-horizontal" style="display: block;" id="anform">
				<input type="hidden" value="${keyset.reType}" id="reTypeId">
				<input type="hidden" value="${keyset.keyServiceNo}" id="anid">
				<input type="hidden" value="${keyset.refImageTextId}" id="refImageTextInfoId">
				<fieldset>
					<legend>回复修改</legend>
					<div class="control-group">
						<label class="control-label" for="keyword">关键词 : </label>
						<div class="controls">
							<input style="border-radius: 5px" id="keyword" type="text" name="keyword" value="${keyset.keyWord}" /><span class="maroon">*</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="answertype">回复类型 : </label>
						<div class="controls">
							<select class="span2" id="answertype" name="answertype" value="${keyset.reType}">
					...
					<div class="control-group" id="textContainer">
						...
						<div class="controls">
							<div class="txtArea">
								...
								<div class="editArea">
									<textarea id="description" name="description" style="display: none;">${keyset.refText }</textarea>
