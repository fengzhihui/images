		...
		<div class="span5 msg-preview">
			<div class="msg-item-wrapper">
				<div id="appmsgItem1" class="appmsgItem msg-item">
					<p class="msg-meta">
						<span class="msg-date">${imageText.createTime}</span>
					</p>
					<div class="cover">
						<p class="default-tip" style="display: none;">封面图片</p>
						<h4 class="msg-t">
							<span class="i-title">${imageText.title}</span>
						</h4>
						...
						<img class="i-img"
							src="${path}/images/upload/${imageText.imageUrl}" style="">
					</div>
					<p class="msg-text"></p>
					<input type="hidden" value="${imageText.imageTextNo}" class="rid">
					<input type="hidden" value="${imageText.title}" class="title">
					<input type="hidden" value="${imageText.imageUrl}" class="cover">
					<input type="hidden" value="${path}/images/upload/${imageText.imageUrl}" class="coverurl">
					<input type="hidden" value="${imageText.sourceUrl}" class="sourceurl">
					<input type="hidden" value="${imageText.clickOutUrl}" class="chain">
					<textarea class="content" style="display: none;">null</textarea>
				</div>

				<c:forEach items="${imageText.subVoList}" var="entry">
					<div class="rel sub-msg-item appmsgItem">
						<span class="thumb"> <span class="default-tip"
							style="display: none;">缩略图</span> <img
							src="${path}/images/upload/${entry.imageUrl}"
							class="i-img">
						</span>
						<h4 class="msg-t">
							<span class="i-title">${entry.title}</span>
						</h4>
						<ul class="abs tc sub-msg-opr">
							<li class="b-dib sub-msg-opr-item"><a href="javascript:;"
								class="th opr-icon edit-icon">编辑</a></li>
							<li class="b-dib sub-msg-opr-item"><a href="javascript:;"
								class="th opr-icon del-icon">删除</a></li>
						</ul>
						<textarea class="content" style="display: none;">
							${entry.mainText}
						</textarea>
						<input type="hidden" value="${entry.moreImageTextNo}" class="rid">
						<input type="hidden" value="${entry.title}" class="title">
						<input type="hidden" value="${entry.imageUrl}" class="cover">
						<input type="hidden" value="${path}/images/upload/${entry.imageUrl}" class="coverurl">
						<input type="hidden" value="${entry.sourceUrl}" class="sourceurl">
						<input type="hidden" value="${entry.clickOutUrl}" class="chain">
					</div>
				</c:forEach>
			...
			<div class="msg-editer-wrapper">
				<div class="msg-editer">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" value="${imageText.title}" id="title" class="span5"
							...
							<div class="cover-area">
								<div class="cover-hd">
									<input id="file_upload" name="file_upload" type="file"
										...
										id="coverurl" value="${imageText.imageUrl}" name="coverurl"
										type="hidden">
								</div>
								<p id="upload-tip" class="upload-tip">大图片建议尺寸：700像素 * 300像素</p>
								<p id="imgArea" class="cover-bd">
									<img src="${path}/images/upload/${imageText.imageUrl}" id="img">
					...
					<div class="control-group">
						<label class="control-label">正文</label> <span class="maroon">*</span><span
							class="help-inline">(必填,不能超过80000个字符)</span>
						<div class="controls">
							<script id="editor">${imageText.mainText}</script>
						</div>
					</div>
					...
					<div id="chain-block" style="display: none;" class="control-group">
						...
						<div class="controls">
							<input type="text" id="chain" class="span5" value="${imageText.clickOutUrl}"
					...
					<div id="url-block" style="display: none;" class="control-group">
						...
						<div class="controls">
							<input type="text" id="source_url" class="span5"
								value="${imageText.sourceUrl}" style="width: 482px;" name="source_url">
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
					...
					<input id="action" name="action" type="hidden" value="mul_edit">
				</div>
