...
<link rel="stylesheet" type="text/css"
	href="<%= request.getContextPath() %>/index1/css/bootstrap.css" />
<link rel="stylesheet" type="text/css"
	href="<%= request.getContextPath() %>/index1/css/style.css" />
<script type="text/javascript"
	src="<%= request.getContextPath() %>/index1/js/jquery.min.js"></script>
<script src="<%= request.getContextPath() %>/index1/js/jquery1.83.js"></script>
<script src="<%= request.getContextPath() %>/index1/js/bootstrap-transition.js"></script>
<script src="<%= request.getContextPath() %>/index1/js/bootstrap-modal.js"></script>
<script src="<%= request.getContextPath() %>/index1/js/bootstrap-button.js"></script>
<script src="<%= request.getContextPath() %>/index1/js/work.js"></script>
 ...
 -->
		...
		<div class="divmain">
			<div class="biaoge" style="margin-top: 20px">
				<s:select id="addgroup" list="#request.glist.datas"
					listValue="groupName" listKey="wclientgroupInfoNo" disabled="true"
					headerKey="0" headerValue="添加到" onchange="addGroup();"></s:select>
				<table class="table table-bordered table-hover table-condensed"
					...
					<thead>
						<tr class="thead-text">
							...
							<th width="20%"><a href="javascript:doOrderby('name')">用户名称</a></th>
					...
					<s:iterator value="dp.datas" id="id" status="c">
						<tr class="list1">
							...
							<td><input type="hidden" id="users"> <s:i18n
									name="public">
									<!-- 	<s:select id="group" list="#request.glist.datas" listValue="groupName" listKey="wclientgroupInfoNo"
							onchange="updateGroup();"></s:select> -->
									<select
										onchange="updateGroup('<s:property value="weixinOpenid" />',this);">
										<s:iterator value="#request.glist.datas" status="s">
											<s:if
												test="dp.datas[#c.index].wclientgroupInfoNo == #request.glist.datas[#s.index].wclientgroupInfoNo">
												<option value="<s:property value="wclientgroupInfoNo" />"
													selected="selected">
