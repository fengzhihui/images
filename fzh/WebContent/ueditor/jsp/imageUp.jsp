<%@page import="com.fzh.storage.BAEStorage"%>
...
up.upload();
System.out.println("保存下的url : " + up.getUrl());
response.getWriter().print("{'original':'"+up.getOriginalName()+"','url':'"+up.getUrl()+"','title':'"+up.getTitle()+"','state':'"+up.getState()+"'}");

//保存在百度云存储
//String url = BAEStorage.uploadByBAE("http://fzh2014.duapp.com/fzh/ueditor/jsp/"+up.getUrl(), up.getFileName());
