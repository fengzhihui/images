var MODE_TEXT = 0,
	...
	textClient = new WSClient({
		host: "wss://" + window.location.host + "/fzh/websocket/chat",
		type: MODE_TEXT,
		onopen: function() {
...
textClient.initUserList = function(list) {
	...
	for (var i = 0; i < list.length; i++) {
		...
		_str.append('<img class="headpic" height="40" width="40" title="' + list[i] + '" src="../images/websocket/headpic.png"></img>');
...
var videoClient = new WSClient({
	host: "ws://" + window.location.host + "/fzh/websocket/chat/video",
	type: MODE_VIDEO,
	onopen: function() {
...
var audioClient = new WSClient({
	host: "ws://" + window.location.host + "/fzh/websocket/chat/audio",
	type: MODE_AUDIO,
	onopen: function() {
