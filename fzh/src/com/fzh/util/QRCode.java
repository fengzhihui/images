...
public class QRCode {
	...
	public static void main(String[] args) {
		//https://chart.googleapis.com/chart?cht=qr&chs=200x200&choe=UTF-8&chld=L|4&chl=http://www.baidu.com?publicNO=aaaa
		/*&cht=qr 类型为QR二维码
		...
		Q-可以识别已损失25%的数据
		H-可以识别已损失30%的数据*/
		String imgPath = "C:/Users/Administrator/Desktop/qrcode.jpg";
