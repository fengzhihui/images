...
public class Encryption {
	private final String hex_chr = "01zhang789aBcDeF";//不能改
	...
	private String createKL(String inStr) {
	...
	private String createJM(String inStr) {
		char[] a = inStr.toCharArray();
		if (a.length > 1) {
	...
	//===========================
	// 获得字符串,进行MD5加密,并产生为Serv-U FTP的密码形式字符串,并返回该字符串
	//===========================
	private String toMd5Str(String Str)
	{
		return createJM(createKL(toUpperStr(calcMD5(Str))));
	}
	
	public static String MD532(String inStr) {
		inStr = new Encryption().toMd5Str(inStr);
	...
	{
		System.out.println("01zhang789aBcDeF".length());
		//要加密的字符串
//		String pass = "tjr101229wansui";
		String pass = "1318";
		//加密
		System.out.println("pass加密完成后的结果为:"+MD532(pass));
	}
}