package com.fzh.wx.tenpay;

import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

import com.fzh.wx.tenpay.client.TenpayHttpClient;
import com.fzh.wx.tenpay.util.ConstantUtil;
import com.fzh.wx.tenpay.util.JsonUtil;
import com.fzh.wx.tenpay.util.WXUtil;
...
public class AccessTokenRequestHandler extends RequestHandler {
	...
	public static void main(String[] args) {
		...
		System.out.println(getTokenReal());
	}
}
